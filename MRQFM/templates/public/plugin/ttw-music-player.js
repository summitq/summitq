    ...
    $.fn.ttwMusicPlayer = function(playlist, userOptions) {
        ...
        interfaceMgr = function() {
            ...
            function buildInterface() {
                ...
                markup = '<div class="ttw-music-player row" style="margin:auto;width:auto;">' +
                        '<div class="player jp-interface container">' +
                        '<div class="row"><div class="album-cover span4">' +
                        '<span class="img"></span>' +
                        '            <span class="highlight"></span>' +
                        '        </div>' +
                        '        <div class="span8 container"><div class="track-info row">' +
                        '            <p class="title"></p>' +
