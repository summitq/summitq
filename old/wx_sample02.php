...
class wechatCallbackapiTest
{
    ...
    public function responseMsg()
    {
		...
		if (!empty($postStr)){
			...
			$mainContentStr = "你好！欢迎关注“小Q老师”，小Q老师最懂你，他能帮助你找自习室，督促你学习英语，在你不开始的时候为你讲笑话，小Q老师愿成为你大学最亲密的伴侣！回复以下数字：\n\n•1【自习】——找自习室\n•2【听力】——每日听力\n•3【笑话】——开心一刻\n•4【天气】——出行不愁\n•5【美图】——每日美图\n•6【语录】——维基语录"; 
			$classContentStr = "欢迎使用教室管理系统，回复以下感兴趣的内容的数字:\n\n•1【自习】——当前自习室\n•*【菜单】——返回菜单\n•#【目录】——返回主目录";
			$listenContentStr = "欢迎进入听力学习，进一步操作，请回复一下数字:\n\n•1【音频】——听力音频\n•2【原文】——听力原文\n•3【译文】——听力译文\n•*【菜单】——返回菜单\n•#【目录】——返回主目录";
			$jokeContentStr = "不开心么，小Q老师在你不开始的时候为你讲笑话，希望你天天有个好心情。请回复一下数字:\n•1【笑话】——幽默笑话\n•*【菜单】——返回菜单\n•#【目录】——返回主目录";
			$weatherContentStr = "根据中央气象局发布的气象预报，回复一下数字:\n\n•1【天气】——当地天气\n•*【菜单】——返回菜单\n•#【目录】——返回主目录";
			$pictureContentStr = "一张图书写一个世界！点点滴滴，发现生活中的美。请回复一下数字:\n\n•1【美图】——精美图片\n•*【菜单】——返回菜单\n•#【目录】——返回主目录";
			$wikiquoteContentStr = "看看语录，静静心，名人名言能改变你的心情！每日维基语录。请回复一下数字:\n\n•1【语录】——维基语录\n•*【菜单】——当前菜单\n•#【目录】——返回主目录";
